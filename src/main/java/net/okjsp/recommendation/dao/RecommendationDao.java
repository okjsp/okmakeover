...
public interface RecommendationDao {
     ...
     * @return
     */
    public List<Recommendation> selectRecommendations(@Param("boardId") String boardId,
     ...
     * @return
     */
    public List<Recommendation> selectRecommendationsByGuboon(@Param("boardId") String boardId,
            @Param("writeNo") String writeNo,
            @Param("commentId") String commentId,
     ...
     * @return
     */
    public List<Recommendation> selectRecommendationsByUser(@Param("userId") String userId);
     ...
     * @return
     */
    public Integer selectCountByGuboon(@Param("boardId") String boardId,
            @Param("writeNo") String writeNo,
            @Param("commentId") String commentId,
            @Param("guboonId") String guboonId);
