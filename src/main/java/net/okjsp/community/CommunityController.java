...
public class CommunityController extends BasicLayoutController {
	...
	public @ResponseBody
	PagingList list(@PathVariable int boardId, @PathVariable int categoryId,
			Paging paging) {

		List<Article> list = communityService.getArticles(boardId, categoryId,
				paging);
	...
	public String listAsHTML(@PathVariable int boardId,
			@PathVariable int categoryId, Paging paging, Model model) {
	...
	public @ResponseBody
	Article view(@PathVariable int boardId, @PathVariable int categoryId,
	...
	public String viewAsHTML(@PathVariable int boardId,
			@PathVariable int categoryId, @PathVariable int writeNo, Model model) {
	...
	public String createForm(@PathVariable int boardId,
	...
	public String create(@PathVariable int boardId,
			@PathVariable int categoryId,
			@Valid @ModelAttribute Article article, BindingResult result,
	...
	public String modifyForm(@PathVariable int boardId,
			@PathVariable int categoryId, @PathVariable int writeNo,
	...
	public String createComment(@PathVariable int boardId,
			@PathVariable int categoryId, @PathVariable int writeNo,
			@ModelAttribute Comment comment, Authentication authentication) {
